  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-lg max-w-2xl">
        <h2 className="text-2xl font-bold mb-4">Welcome to the Museum Experience!</h2>
        <div className="space-y-4">
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>Choose between two modes of interaction:
              <ul className="list-disc list-inside ml-4 mt-1">
                <li><strong>Manual:</strong> Press and hold the "Push to talk" button while speaking</li>
                <li><strong>VAD:</strong> Automatic voice detection - just speak naturally</li>
              </ul>
            </li>
...
export function ConsolePage() {
  ...
  useEffect(() => {
    const hasSeenInstructions = localStorage.getItem('museum::has_seen_instructions');
